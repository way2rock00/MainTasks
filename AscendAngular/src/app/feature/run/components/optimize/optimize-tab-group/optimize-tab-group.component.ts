...
@Component({
  selector: 'app-optimize-tab-group',
  templateUrl: './optimize-tab-group.component.html',
  styleUrls: ['./optimize-tab-group.component.scss']
})
export class OptimizeTabGroupComponent implements OnInit {
