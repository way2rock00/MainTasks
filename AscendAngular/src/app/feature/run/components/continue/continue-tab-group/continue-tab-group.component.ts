...
@Component({
  selector: 'app-continue-tab-group',
  templateUrl: './continue-tab-group.component.html',
  styleUrls: ['./continue-tab-group.component.scss']
})
export class ContinueTabGroupComponent implements OnInit {
