...
@Component({
  selector: 'app-stabilize-page',
  templateUrl: './stabilize-page.component.html',
  styleUrls: ['./stabilize-page.component.scss']
})
export class StabilizePageComponent implements OnInit, OnDestroy {
