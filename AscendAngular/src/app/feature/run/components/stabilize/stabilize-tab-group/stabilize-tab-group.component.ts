...
@Component({
  selector: 'app-stabilize-tab-group',
  templateUrl: './stabilize-tab-group.component.html',
  styleUrls: ['./stabilize-tab-group.component.scss']
})
export class StabilizeTabGroupComponent implements OnInit {
