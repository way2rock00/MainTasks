...
@Component({
  selector: 'app-construct-tab-group',
  templateUrl: './construct-tab-group.component.html',
  styleUrls: ['./construct-tab-group.component.scss']
})
export class ConstructTabGroupComponent implements OnInit {
