...
@Component({
  selector: 'app-validate-tab-group',
  templateUrl: './validate-tab-group.component.html',
  styleUrls: ['./validate-tab-group.component.scss']
})
export class ValidateTabGroupComponent implements OnInit {
