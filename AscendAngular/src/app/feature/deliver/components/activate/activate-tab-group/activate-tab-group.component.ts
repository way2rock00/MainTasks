...
@Component({
  selector: 'app-activate-tab-group',
  templateUrl: './activate-tab-group.component.html',
  styleUrls: ['./activate-tab-group.component.scss']
})
export class ActivateTabGroupComponent implements OnInit {
