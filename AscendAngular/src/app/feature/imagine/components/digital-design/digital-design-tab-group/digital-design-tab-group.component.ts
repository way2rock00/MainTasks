...
@Component({
  selector: "app-digital-design-tab-group",
  templateUrl: "./digital-design-tab-group.component.html",
  styleUrls: ["./digital-design-tab-group.component.scss"]
})
export class DigitalDesignTabGroupComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.tabs = this.layoutConfig.right.tabs; //tab changes
  ...
  //Filter changes
  setCurrentTab() {
    this.currentTab = this.tabs.find(t => decodeURI(this.router.url) == t.tabURL);
