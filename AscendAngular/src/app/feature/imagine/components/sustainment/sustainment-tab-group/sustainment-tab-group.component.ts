...
@Component({
  selector: 'app-sustainment-tab-group',
  templateUrl: './sustainment-tab-group.component.html',
  styleUrls: ['./sustainment-tab-group.component.scss']
})
export class SustainmentTabGroupComponent implements OnInit {
