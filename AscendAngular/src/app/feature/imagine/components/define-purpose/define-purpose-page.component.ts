...
@Component({
  selector: 'app-define-purpose-page',
  templateUrl: './define-purpose-page.component.html',
  styleUrls: ['./define-purpose-page.component.scss']
})
export class DefinePurposePageComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.definePurposeTabDataService.clearData();
  ...
  onFilterChange(e){
    ...
    if(this.currentTabCode){  //Filter Changes
      ...
      if (e) {
        this.definePurposeTabDataService
        .setSelectedFilter(e)
        .subscribe(() => {
          this.setFilters();
