...
@Component({
  selector: 'app-define-purpose-tab-group',
  templateUrl: './define-purpose-tab-group.component.html',
  styleUrls: ['./define-purpose-tab-group.component.scss']
})
export class DefinePurposeTabGroupComponent implements OnInit {
