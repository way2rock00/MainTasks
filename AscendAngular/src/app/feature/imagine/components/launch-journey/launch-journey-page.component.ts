...
import { LAYOUT_IMAGINE_SUB_NAV, LAYOUT_TYPE, LAYOUT_CONFIGURATION } from 'src/app/shared/constants/layout-constants';
...
import { LaunchJourneyTabDataService } from '../../services/launch-journey/launch-journey-tab-data.service';

@Component({
  selector: 'app-launch-journey-page',
  templateUrl: './launch-journey-page.component.html',
  styleUrls: ['./launch-journey-page.component.scss']
})
export class LaunchJourneyPageComponent implements OnInit {

  LAYOUT: LAYOUT_TYPE = LAYOUT_TYPE.IMAGINE;
  SUB_NAV: LAYOUT_IMAGINE_SUB_NAV = LAYOUT_IMAGINE_SUB_NAV.LAUNCH;
  ...
  constructor(
    ...
    private launchJourneyTabDataService: LaunchJourneyTabDataService,
  ...
  onFilterChange(e) {
    if (this.currentTabCode) {  //Filter Changes
      ...
      if (e) {
        this.launchJourneyTabDataService
          .setSelectedFilter(e)
          .subscribe(() => {
            this.setFilters();
